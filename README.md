...
- 報到處：三樓（即救護站）
- 美食餐盒：三樓報到處外走廊，**11:30–13:30** 發放
- 五十週年紀念禮：保溫瓶（員工限定、全程參加），活動現場不發放，結束後回廠發放
- 現場問題：廣運福利委員會、三樓服務台

## 最近內容更新

- 時光探險第 3 關「廣運歷史小測驗」已更新為五題三選一，涵蓋廣運創立日期、盛新材料科技、創立初期核心技術、永暘光學與太極能源。
- 時光探險題目來源為 `time-adventure/puzzles.json`；修改後須執行 `py scripts/split-time-adventure.py`，再部署至 LEGOWORKS。
